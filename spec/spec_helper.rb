...
RSpec.configure do |config|
  ...
  # starts an Elasticsearch test server, unless it is already running.
  ...
  # Stop elasticsearch cluster after test run if it is running.
  ...
  # Create a new Elasticsearch index for each model that is configured with Elasticsearch
